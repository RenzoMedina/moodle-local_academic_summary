...
$string['email'] = 'Email';
$string['email_help'] = 'Enter the email address of the student you want to search for. You can also use the username field to search by username.';
...
$string['notracking'] = 'No progress';
$string['noupcomingevents'] = 'No upcoming events.';
$string['nouserfound'] = 'No user found with the provided username or email.';
...
$string['username_help'] = 'Enter the username of the student you want to search for. You can also use the email address field to search by email.';

...
$string['email_help'] = 'Ingrese la dirección de correo electrónico del estudiante que desea buscar. También puede usar el campo de nombre de usuario para buscar por nombre de usuario.';
...
$string['notracking'] = 'Sin progreso';
$string['noupcomingevents'] = 'No hay eventos próximos.';
$string['nouserfound'] = 'No se encontró ningún usuario con el nombre de usuario o correo electrónico proporcionado.';
...
$string['username_help'] = 'Ingrese el nombre de usuario del estudiante que desea buscar. También puede usar el campo de dirección de correo electrónico para buscar por correo electrónico.';
